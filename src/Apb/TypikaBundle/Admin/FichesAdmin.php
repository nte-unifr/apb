...
use Apb\TypikaBundle\Entity\Fiches;
    ...
    protected function configureShowField(ShowMapper $showMapper)
    {
        $showMapper
            ...
            ->with('Contenu')
                ...
                ->add('region')
                ->add('bibliographie')
                ->add('image', null, array('template' => 'ApbTypikaBundle::media.html.twig'))
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('public', null, array(
                ...
                'template' => 'ApbTypikaBundle:Fiches:crudpublic.html.twig'
            ))
            ->addIdentifier('titre')
            ...
            ->add('image', 'sonata_type_model', array('template' => 'ApbTypikaBundle:Fiches:crudimage.html.twig'))
